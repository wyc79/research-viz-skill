...
if not PARSED_CSV.exists():
    st.warning(
        "No parsed dataset yet. Run `bash visualizations/parseinput.sh` first, then refresh this page."
    )
    st.stop()
...
st.caption(
    ...
    "They will appear in the sidebar automatically. See `info/howtouse.md` for details."
)
