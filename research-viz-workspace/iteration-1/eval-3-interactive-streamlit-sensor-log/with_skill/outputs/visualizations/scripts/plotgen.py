#!/usr/bin/env python3
"""
plotgen.py — generate a static research plot from parsed_results.csv based on a plain-English prompt.
...
from fcns.utils import slugify, set_research_theme  # noqa: E402
...
def main() -> int:
    ...
    p.add_argument("--data", required=True, help="CSV produced by parser.py (parsed_results.csv)")
    ...
    spec_path.write_text(json.dumps({"prompt": args.prompt, "data_source": args.data, "slug": slug}, indent=2))
